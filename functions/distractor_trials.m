function distractor_trials(datafilepointer2, w, gray, rectSize, numRects, objRect, dstRect, xs, ys, img_gap, imgwidth, borderwidth, imgheight, bordercolor2, cue_duration, min_pretarget, max_pretarget, duration, std_gap, irr_tarray, low_keypress, high_keypress, keyone, keytwo, slack)
