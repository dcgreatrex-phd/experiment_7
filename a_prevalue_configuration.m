function a_prevalue_configuration(subNo)
...
try  
    ...
    message = 'Task 1 \n\n\n\n Imagine you are flicking through radio stations. What sound makes you stop and tune into the station? \n\n\n\n In each trial of this experiment you will hear a very short sound clip \n\n and see an image of the CD it comes from, taken from the set you \n\n heard before. The only difference is that the clips are shorter now. \n\n\n\n Your tasks are to say: \n\n 1) How well you know it. \n\n 2) How likely you are to pick this tune because you like it. \n\n\n\n You do not need to recall the specific recording of a track for it to \n\n be familiar and your response should represent how you feel now. \n\n\n\n Press the mouse button to continue ...';    
    onscreen_text(w, message)
    
    % 4.3.2 - Display first instruction message - run function (onscreen_text)
    if p_type == 1;
        Screen('DrawTexture', w, score_img1_1, [], scorelocation1);
        Screen('DrawTexture', w, score_img1_2, [], scorelocation2);
    elseif p_type == 2;
        Screen('DrawTexture', w, score_img2_1, [], scorelocation1);
        Screen('DrawTexture', w, score_img2_2, [], scorelocation2);    
    end    
        
    message = 'Your response options look like this: \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n If you want to hear the music again, press the _R_ key. \n\n\n\n Press the mouse button to continue ...';  
    onscreen_text(w, message)  
    ...
    try           
       ...
       % prevalue_practice_trials(w, xs, ys, practicefilename, img_folder, imgwidth, imgheight, bordercolor1, borderRect1, min_pretarget, max_pretarget, irr_tarray, target, duration, response, aperture2, aperture3, p_type, keypress_1, keypress_2, keypress_3, keypress_4, keypress_5, keypress_repeat, scorelocation, score_img1_1, score_img1_2, score_img2_1, score_img2_2, slack)        
    catch
    ...
    message = 'Do you have any questions? \n\n OK, start task 1 now. Most people take about 15 minutes. There is a break half way through. \n\n\n\n Press the mouse button to begin...';    
    onscreen_text(w, message)
...
%         disp(famil_counter);
        ...
        fprintf(datafilepointer,'%i %s %s %s %s %i %i %s %i %i %i %i\n', ...  
          objnumber(trial), ...
          filename1{trial}, ...
          soundname1{trial}, ...
          genre{trial}, ...
    ...
    message = 'End of Task 1. Thank you. \n\n press the mouse button to start task 2 ...';
    onscreen_text(w, message)
    ptb_cleanup ()
