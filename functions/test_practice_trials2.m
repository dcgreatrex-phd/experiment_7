function test_practice_trials2(testpfilename,w,gray,wRect,rectSize,numRects,scale,img_gap,imgwidth,imgheight,borderwidth,img_folder,bordercolor1,bordercolor2,cue_duration,min_pretarget,max_pretarget,duration,response,std_gap,irr_tarray,target,low_keypress,high_keypress,slack)
